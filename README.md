...
입력: MP4 / WebM / MOV / MKV / M4V / AVI, 1.1GiB 이하 (UI 표기는 1.1GB, 최대 1,181,116,006바이트). 내부 코덱에 따라 지원 여부가 달라집니다. 출력: MP4 (H.264/AAC), GIF (최대 30초), MP3. 해상도는 높이 기준이며 업스케일하지 않습니다. 품질 기반 압축이므로 목표 바이트 크기를 보장하지 않습니다. 큰 파일은 메모리 제한으로 실패할 수 있습니다.
